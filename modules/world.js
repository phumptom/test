...
/**
 * World/scene building extracted from game.js.
 * Usage: installWorld(gameInstance);
 * Attaches createGround(), createSkySphere(), createBoundaryWalls(), createBannerFrames(),
 * setBannerImage(), createChartCandlesAndWalls() onto the instance.
 */
export function installWorld(game) {

  game.createGround = function createGround() {
  ...
  game.createSkySphere = function createSkySphere() {
  ...
  game.createBoundaryWalls = function createBoundaryWalls(fieldSize) {
  ...
  game.createBannerFrames = function createBannerFrames(fieldSize) {
  ...
  game.setBannerImage = function setBannerImage(id, url) {
  ...
  // Obstacles
  game.createChartCandlesAndWalls = function createChartCandlesAndWalls(fieldSize) {
