// Step 1 extracted math helpers from game.js
// Attaches geometry & movement helpers to SurvivorGame.prototype
import * as THREE from 'three';

export function attachGeometry(SurvivorGame) {
  // ---------- Geometry helpers ----------
  SurvivorGame.prototype.computeObstacleAABBs = function () {
  ...
  SurvivorGame.prototype.segmentIntersectsBox = function (p0, p1, box, expand = 0) {
  ...
  SurvivorGame.prototype.hasLineOfSight = function (start, end) {
    for (const ob of this.obstacles) {
  ...
  SurvivorGame.prototype.pathHitsObstacle = function (p0, p1, radius = 0.05) {
    for (const ob of this.obstacles) {
      if (ob.type !== 'box') continue;
  ...
  SurvivorGame.prototype.checkObstacleCollision = function (position, radius = 1) {
  ...
  SurvivorGame.prototype.isWithinFieldBounds = function (position, radius = 0) {
  ...
  SurvivorGame.prototype.collidesWithEnemies = function (position, radius) {
  ...
  SurvivorGame.prototype.tryMovePlayer = function (deltaVec) {
